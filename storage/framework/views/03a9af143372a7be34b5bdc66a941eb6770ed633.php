		...
		<div class="card-body">
		 <div class="card-content p-2">
		  <div class="text-center">
		 		...
		 		<h4 class="text-light">Cosmo Luxary Sanitary</h4>
			...
			<div class="form-row mr-0 ml-0">
			 <div class="form-group col-6">
			   <div class="demo-checkbox">
                <input type="checkbox" id="remember" name="remember" class="filled-in chk-col-danger" />
                <label for="remember">Remember me</label>
			  </div>
			 </div>


			 <!-- <div class="form-group col-6 text-right text-light">
			  <a href="https://localhost/project/" class="text-light">Back to home page </a>
			 </div>  -->
			</div>
			
			 <div class="form-group">
			   <button type="submit" class="btn btn-dark btn-block waves-effect waves-light">Sign In</button>
			 </div>
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\Cosmo_luxary_sanitary_ware\Cosmo_luxary_sanitary_ware\resources\views/expert/login.blade.php ENDPATH**/ ?>