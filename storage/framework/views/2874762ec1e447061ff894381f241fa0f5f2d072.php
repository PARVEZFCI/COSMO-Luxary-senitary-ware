<?php $__env->startSection('title', 'Investigation Add - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
          ...
          <div class="card bg-dark">
            ...
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-plus-circle"></i> Add New Investigation  
              </div> 
            </div>
            
            <div class="card-body">

              <form action="<?php echo e(url('admin/investigationsac')); ?>" id="qcat" method="post">
              <?php echo csrf_field(); ?>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="code_test" name="code_test" placeholder="Enter Code">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="inv_name" name="inv_name" placeholder="Enter Investigation Name">
                      </div>
                  </div>

                  <div class="col-md-12">
                      <div class="form-group">
                          <label for="name">Investigation Reference Value </label>
                          <textarea class="form-control" id="inv_ref_value" name="inv_ref_value" placeholder="Enter Investigation Reference Value"></textarea>
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="report_file_name" name="report_file_name" placeholder="Enter Report File Name">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="report_days" name="report_days" placeholder="Enter Report Days">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="number" class="form-control" id="charge" name="charge" placeholder="Enter Charge">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="number" class="form-control" id="discount" name="discount" placeholder="Enter Discount">
                      </div>
                  </div>
...
$('#inv_ref_value').summernote({
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/investigations/investigationsadd.blade.php ENDPATH**/ ?>