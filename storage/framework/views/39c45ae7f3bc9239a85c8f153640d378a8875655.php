 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper -->
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="<?php echo e(url('admin/officeaccounts')); ?>" class="waves-effect">
          <i class="fa fa-user-secret"></i> <span> Category Accounts</span>
        </a>
      </li>

       <li>
        <a href="<?php echo e(url('admin/incomemanage')); ?>" class="waves-effect">
          <i class="fa fa-user-secret"></i> <span> Income manage</span>
        </a>
      </li>

      <li>
        <a href="<?php echo e(url('admin/expansemanage')); ?>" class="waves-effect">
          <i class="fa fa-user-secret"></i> <span> Expanse manage</span>
        </a>
      </li>
...
<!-- End sidebar-wrapper
<?php /**PATH F:\Xampp\htdocs\MODERN-HOSPITAL-PRIVATE\resources\views/expert/sidebar.blade.php ENDPATH**/ ?>