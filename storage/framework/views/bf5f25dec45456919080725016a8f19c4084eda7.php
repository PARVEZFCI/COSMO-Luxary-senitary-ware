...
<div class="clearfix"></div>
        ...
        <div class="col-lg-8">
          ...
          <div class="card bg-dark">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo e(url('admin/sizeUpdate',$productsize->id)); ?>" id="qcat" method="post">
              <?php echo csrf_field(); ?>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="product_type">
                          	<option ><?php echo e($productsize->product_type); ?></option>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" value="<?php echo e($productsize->size); ?>" type="text" class="form-control" id="amount" name="size" placeholder="Enter product Size">
                      </div>
                  </div>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SERVER\htdocs\AB-Ceramic-Industries\resources\views/admin/size/productsizeedit.blade.php ENDPATH**/ ?>