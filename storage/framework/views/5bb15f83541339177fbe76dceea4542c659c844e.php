<?php $__env->startSection('title', 'Ref Add - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
        ...
        <div class="col-lg-8">
          ...
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-list"></i><span>  Ref Manage </span>
            </div>

            <div class="card">
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-plus-circle"></i> Add New Ref  
              </div> 
            </div>
            
            <div class="card-body">

              <form action="<?php echo e(url('admin/refaddac')); ?>" id="qcat" method="post">
              <?php echo csrf_field(); ?>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="ref_code" name="ref_code" placeholder="Enter Ref Code">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="ref_name" name="ref_name" placeholder="Enter Ref Name">
                      </div>
                  </div>

                  <div class="col-md-6">
                      <div class="form-group">
                          <label for="name">Ref Phone </label>
                          <input type="number" class="form-control" id="ref_phone" name="ref_phone" placeholder="Enter Ref Phone">
                      </div>
                  </div>

                  <div class="col-md-6">
                      <div class="form-group">
                          <label for="name">Ref Address </label>
                          <input type="text" class="form-control" id="ref_address" name="ref_address" placeholder="Enter Ref Address">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <a href="<?php echo e(url('admin/refmanage')); ?>" class="btn btn-dark btn-block col-md-offset-2">
...
$("#cus_order_id").on('keyup',function(){
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/refmanage/refadd.blade.php ENDPATH**/ ?>