...
<div class="clearfix"></div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-lg-8">
          ...
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-user-circle"></i><span> Income Manage</span>
            </div>
            ...
            <div class="card-header">
              ...
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> Income Manage List
              </div> 
            ...
            <div class="card-body">
              ...
              <table id="dataTable" class="table table-bordered">
                ...
                <tbody>
                    <?php $i=1; ?>
                   <?php $__currentLoopData = $income_manage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-lg-4">
          ...
          <div class="card bg-dark">
          <div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-user-circle"></i><span>Income Manage Add</span>
            </div>
            ...
            <div class="card-header">
              ...
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> New Income Manage
              </div> 

            </div>
            <div class="card-body">
             
              <form action="<?php echo e(url('admin/incomemanageadd')); ?>" id="qcat" method="post">
              <?php echo csrf_field(); ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Xampp\htdocs\MODERN-HOSPITAL-PRIVATE\resources\views/admin/office/incomemanage.blade.php ENDPATH**/ ?>