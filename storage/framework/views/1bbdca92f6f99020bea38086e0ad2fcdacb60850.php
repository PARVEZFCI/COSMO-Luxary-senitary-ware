               ...
               <div class="row">
                  <div class="col-md-6">
                   ...
                   <div class="form-group">
                     ...
                     <input type="hidden"  readonly="" name="f_prev_due" class="form-control" id="f_prev_due">
                   </div>
               ...
               <div  class="row">
                 ...
                 <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input class="form-control" value=""  type="text" id="tt_deposit_balance" name="tt_deposit_balance" placeholder="TT/Deposit balance" required="">
                      </div>
                 </div>
                 <div class="col-md-2"></div>
...
/*alert(cashmemoid);*/
   $.ajax({
        url: "<?php echo e(url('admin/calculate_total_ctn_with_comm')); ?>",
        data: {cashmemoid:cashmemoid},
        success: function(data){
        $("#t_w_comm").html(data);
        $("#t_w_comm").val(data);
                 ...
                 $.ajax({
                     ...
                     success:function(data) {
                        //var d =$('input[name="product_name"]').empty();
                           ...
                           $('#f_prev_due').val(data.f_openig_due);
...
swal({
      ...
      .then((willDelete) => {
          if (willDelete) {
              $.ajax({
                  url: "<?php echo e(url('admin/med_sales_delete_from_cart_add_page')); ?>",
                  data: {data},
                  success: function(data){
                    $("#purchase").find("#show_add_to_cart_item").html(data);
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\Cosmo_luxary_sanitary_ware\resources\views/admin/cashmemo/cashmemonw.blade.php ENDPATH**/ ?>