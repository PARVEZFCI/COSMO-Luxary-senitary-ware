...
<div class="clearfix"></div>
              ...
              <table id="dataTable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          <?php if(empty($data->report_status)): ?>
                            <a href="<?php echo e(url('admin/testalllistresprint',$data->id)); ?>" class="btn btn-warning btn-sm waves-effect waves-light">
                            <i class="fa fa-clipboard"></i> <span>
                            Print Report
                          </span>
                          </a>
                          <?php else: ?>
                            <a href="<?php echo e(url('admin/testalllistresprint/'.$data->pat_id . '/' . $data->id)); ?>" class="btn btn-warning btn-sm waves-effect waves-light">
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xamppp\htdocs\hospital_management\modern_hospital_private\resources\views/admin/lab/testlistprint.blade.php ENDPATH**/ ?>