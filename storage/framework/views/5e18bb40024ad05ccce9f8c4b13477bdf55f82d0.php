             ...
             <div class="col-md-6">
               <div  class="row">
                    ...
                    <div class="col-md-3">
                          ...
                          <input class="form-control" value="<?php echo e($bill_edit->total); ?>"  readonly="" type="number" id="total_taka" name="total_taka" placeholder="total taka">
                        </div>
                    </div>
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Xampp\htdocs\Cosmo_luxary_sanitary_ware\Cosmo_luxary_sanitary_ware\resources\views/admin/cashmemo/cashmemoedit.blade.php ENDPATH**/ ?>