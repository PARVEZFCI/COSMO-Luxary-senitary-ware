        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input required="" type="text" class="form-control" id="phone" name="phone" placeholder="Enter Phone" value="<?php echo e($settings->phone); ?>">
                </div>
            </div>
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SERVER\htdocs\project\Cosmo_luxary_sanitary_ware\resources\views/admin/settings.blade.php ENDPATH**/ ?>