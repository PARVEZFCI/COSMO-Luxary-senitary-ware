<?php $__env->startSection('title', 'OPD - Out Patient Manage - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
...
<div class="clearfix"></div>
        ...
        <?php endif; ?>
          ...
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-user-circle"></i><span> OPD - Out Patient Manage</span>
            </div>
            ...
            <div class="card-header">
              ...
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> OPD - Out Patient List
              </div> 
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xamppp\htdocs\hospital_management\modern_hospital_private\resources\views/admin/patients/opd.blade.php ENDPATH**/ ?>