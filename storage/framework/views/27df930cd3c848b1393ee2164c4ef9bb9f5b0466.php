...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form id="purchase" action="<?php echo e(url('admin/updatecashmemo')); ?>" method="post">
           <?php echo csrf_field(); ?>
      <div class="row">
        <div class="col-lg-12">
    ...
    <h4 class="text-center pt-3">Select Customer</h4><hr>
       ...
       <div class="card-body">
          ...
          <div class="row">
           <input type="hidden" name="cashmemo" id="cashmemo" value="<?php echo e($bill_edit->cash_memo_id); ?>">
            ...
            <div class="col-md-3"></div>
               ...
               <div class="col-md-3">
                  <div class="form-group">
                    ...
                    ?>
                    <input class="form-control" type="date" id="date" value="<?php echo e($bill_edit->date); ?>" name="date" placeholder="Date">
                  </div>
                </div>
         ...
         <div class="row">
              ...
              <div class="col-md-3">
               <div class="form-group">
                   ...
                   <?php echo e($bill_edit->customer_code); ?>

                    <select class="form-control" id="customer_code" name="customer_code">
                      
                        <option value="<?php echo e($bill_edit->customer_code); ?>" ><?php echo e($bill_edit->customer_code); ?> </option>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    <label>Customer Name</label>
                    <input class="form-control" type="text" id="customer_name" name="customer_name" placeholder="Customer  Name" value="<?php echo e($bill_edit->customer_name); ?>">
                  </div>
                </div>
                ...
                <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input class="form-control"  value="<?php echo e($bill_edit->customer_address); ?>" type="text" id="customer_address" name="customer_address" placeholder="Customer Address ">
                  </div>
                </div>

          
                  
                    <input class="form-control" type="hidden" value="<?php echo e($bill_edit->customer_phone); ?>" id="customer_phone" name="customer_phone" placeholder="Customer Phone ">
                
               
               <div class="col-md-2">
                  <div class="form-group">
                    <label>Ship To</label>
                    <input class="form-control" type="text" value="<?php echo e($bill_edit->ship_to); ?>" id="ship_to" name="ship_to" placeholder="Ship  To ">
                  </div>
                </div>
                 ...
                 <div class="col-md-2">
                  <div class="form-group">
                    ...
                    <input class="form-control" value="<?php echo e($bill_edit->truck_no); ?>" type="text" value="0" id="truck_no" name="truck_no" placeholder="Truck No ">
                  </div>
                </div>
                      ...
                      <tbody>
                        ...
                        <?php $__currentLoopData = $salesItem; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <tr>
                           ...
                           <td><?php echo e($data->comission); ?>&nbsp;&nbsp;&nbsp;&nbsp; </td>
                           <td><?php echo e($data->total_price); ?></td>
                          

                              <td>
                                <button type="button" onclick="editcart(this)" class="btn btn-sm btn-info" id="edit" data-id="<?php echo e($data->id); ?>"><i class="fa fa-edit"></i></button>
               ...
               <div class="row">
                  <div class="col-md-6">
                   ...
                   <div class="form-group">
                     ...
                     <input class="form-control" value="<?php echo e($bill_edit->Prev_due); ?>" readonly=""  type="text" id="openig_due" name="openig_due" placeholder="due">

                      <input type="hidden" readonly="" value="<?php echo e($bill_edit->f_prev_due); ?>" name="f_prev_due" class="form-control" id="f_prev_due">
                      <input type="hidden" name="f_prev_due_edit" value="<?php echo e($customer->f_openig_due); ?>" class="form-control" >
                   </div>
                 ...
                 <div class="col-md-4">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="cash_info" value="<?php echo e($bill_edit->cash_info); ?>" id="cash_info" class="form-control" placeholder="Entr cash Info">
                 ...
                 <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="text" name="cash" value="<?php echo e($bill_edit->cash); ?>" id="cash" class="form-control" placeholder="Entr cash balance">
                 ...
                 <div class="col-md-2"></div>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->carriage_info); ?>"  type="text" id="carriage_info" name="carriage_info" placeholder="Entr carriage info">
                    </div>
                 ...
                 <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->carriage); ?>"  type="text" id="carriage" name="carriage" placeholder="Entr carriage">
                    </div>
                ...
                <div class="col-md-6">
                     ...
                     <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->breakage_info); ?>"  type="text" id="breakage_info" name="breakage_info" placeholder="Entr breakage info">
                    </div>
                 ...
                 <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->breakage); ?>"  type="text" id="breakage" name="breakage" placeholder="Entr breakage">
                    </div>
                ...
                <div class="col-md-6">
                     <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->incentives_info); ?>" type="text" id="incentives_info" name="incentives_info" placeholder="incentives Info">
                    </div>
                 ...
                 <div class="col-md-4">
                     <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->incentives); ?>" type="text" id="incentives" name="incentives" placeholder="incentives">
                    </div>
                ...
                <div class="col-md-6">
                     ...
                     <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->comission_info); ?>"  type="text" id="comission_info" name="comission_info" placeholder="Entr comission info">
                    </div>
                 ...
                 <div class="col-md-4">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" value="<?php echo e($bill_edit->comission_balance); ?>" type="text" id="comission_balance" name="comission_balance" placeholder="Entr comission balance">
                    </div>
             ...
             <div class="col-md-6">
               <div  class="row">
                    ...
                    <div class="col-md-3">
                          ...
                          <input class="form-control" value="<?php echo e($total_price); ?>"  readonly="" type="number" id="total_taka" name="total_taka" placeholder="total taka">
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                          ...
                          <input class="form-control" value="<?php echo e($total_quantity); ?>"  readonly="" type="number" id="total_taka" name="total_taka" placeholder="total taka">
                        </div>
                    </div>
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo e($bill_edit->special_discount_info); ?>"  type="text" id="special_discount_info" name="special_discount_info" placeholder="Entr special discount Info" >
                      </div>
                 ...
                 <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo e($bill_edit->discount); ?>"  type="text" id="special_discount" name="special_discount" placeholder="Entr special discount" >
                      </div>
                 </div>
                 <div class="col-md-2"></div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo e($bill_edit->tt_deposit_info); ?>"  type="text" id="tt_deposit_info" name="tt_deposit_info" placeholder="Entr TT/Deposit info" >
                      </div>
                 ...
                 <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo e($bill_edit->tt_deposit_balance); ?>"  type="text" id="tt_deposit_balance" name="tt_deposit_balance" placeholder="TT/Deposit balance" >
                      </div>
                 </div>
                 <div class="col-md-2"></div>
                 ...
                 <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo e($bill_edit->missig_deposit_info); ?>"  type="text" id="missig_deposit_info" name="missig_deposit_info" placeholder="Entr TT/Deposit info" >
                      </div>
                 ...
                 <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input class="form-control" value="<?php echo e($bill_edit->missig_deposit_balance); ?>"  type="text" id="missig_deposit_balance" name="missig_deposit_balance" placeholder="Missing Deposit  Balance" >
                      </div>
                 </div>
                 <div class="col-md-2"></div>
                 ...
                 <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="other_info" value="<?php echo e($bill_edit->other_info); ?>" class="form-control" id="other_info" placeholder="Entr Other Info">
                 ...
                 <div class="col-md-4">
                     <div class="form-group">
                      ...
                      <input type="text" name="other" value="<?php echo e($bill_edit->other); ?>" class="form-control" id="other" placeholder="Entr Other">
      ...
      <div class="row" style="margin-top: 15px;">
        ...
        <div class="col-md-6">
           ...
           <div class="form-group">
               ...
               <?php if($bill_edit->condition !=NULL): ?>
...
console.log(date);
$.ajax({
        url: "<?php echo e(url('admin/checkcustomer')); ?>",
        data: {
...
function editcart(ele){
  var data = $(ele).data("id");
   ...
   $.ajax({
              url: "<?php echo e(url('admin/editcartwith')); ?>",
             data: {data},
            success: function(data){
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/nsbusine/public_html/Cosmo_luxary_sanitary_ware/resources/views/admin/cashmemo/cashmemoedit.blade.php ENDPATH**/ ?>