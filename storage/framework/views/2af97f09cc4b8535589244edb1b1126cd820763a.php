<?php $__env->startSection('title', 'Patients Manage - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
...
<div class="clearfix"></div>
        ...
        <?php endif; ?>
          ...
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-user-circle"></i><span> Patients Manage</span>
            </div>
            ...
            <div class="card-header">
              ...
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> Patients List
              </div> 
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/patients/patients.blade.php ENDPATH**/ ?>