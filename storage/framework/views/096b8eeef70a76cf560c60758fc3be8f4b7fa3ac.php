<?php $__env->startSection('title', 'Investigation Edit - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
        ...
        <div class="col-lg-8">
          ...
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-list"></i><span>  Investigations Manage </span>
            </div>

            <div class="card">
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-plus-circle"></i> Investigation Edit
              </div> 
            </div>
            
            <div class="card-body">

              <form action="<?php echo e(url('admin/inveditac',$investigation_manage->id)); ?>" id="qcat" method="post">
              <?php echo csrf_field(); ?>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="code_test" name="code_test" placeholder="Enter Code" value="<?php echo e($investigation_manage->code_test); ?>">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="inv_name" name="inv_name" placeholder="Enter Investigation Name" value="<?php echo e($investigation_manage->inv_name); ?>">
                      </div>
                  </div>
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="unit_test" name="unit_test" placeholder="Unit" value="<?php echo e($investigation_manage->unit_test); ?>">
                      </div>
                  </div>

                  <div class="col-md-12">
                      <div class="form-group">
                          <label for="name">Normal Value </label>
                          <textarea class="form-control" id="inv_ref_value" name="inv_ref_value" placeholder="Enter Normal Value"><?php echo e($investigation_manage->inv_ref_value); ?></textarea>
                      </div>
                  </div>

                  <div class="col-md-6">
                      <div class="form-group">
                          <label for="name">Report File Name </label>
                          <input required="" type="text" class="form-control" id="report_file_name" name="report_file_name" placeholder="Enter Report File Name" value="<?php echo e($investigation_manage->report_file_name); ?>">
                      </div>
                  </div>

                  <div class="col-md-6">
                      <div class="form-group">
                          <label for="name">Report Days </label>
                          <input required="" type="text" class="form-control" id="report_days" name="report_days" placeholder="Enter Report Days" value="<?php echo e($investigation_manage->report_days); ?>">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="number" class="form-control" id="charge" name="charge" placeholder="Enter Charge" value="<?php echo e($investigation_manage->charge); ?>">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="number" class="form-control" id="discount" name="discount" placeholder="Enter Discount" value="<?php echo e($investigation_manage->discount); ?>">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <a href="<?php echo e(url('admin/investigations')); ?>" class="btn btn-dark btn-block col-md-offset-2">
...
$('#inv_ref_value').summernote({
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/investigations/invedit.blade.php ENDPATH**/ ?>