 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper -->
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true" class="border-right border-secondary-light">
     ...
     <h6 class="pt-3 text-light"><?php echo e($settingsinfo->company_name); ?></h6>
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
           ...
           <li>
            <a href="<?php echo e(url('admin/selectdatedailysales')); ?>"><i class="fa fa-file-o"></i>Daily Sales Statement   </a>
          </li>
...
<!-- End sidebar-wrapper
<?php /**PATH D:\Xampp\htdocs\Cosmo_luxary_sanitary_ware\Cosmo_luxary_sanitary_ware\resources\views/expert/sidebar.blade.php ENDPATH**/ ?>