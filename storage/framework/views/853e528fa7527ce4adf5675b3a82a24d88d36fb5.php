<?php $__env->startSection('title', 'Bill Manage - '.$settingsinfo->company_name.' - '.$settingsinfo->soft_name.''); ?>
...
<div class="clearfix"></div>
        ...
        <?php endif; ?>
          ...
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-user-circle"></i><span> Bill Manage</span>
            </div>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/bill/bill.blade.php ENDPATH**/ ?>