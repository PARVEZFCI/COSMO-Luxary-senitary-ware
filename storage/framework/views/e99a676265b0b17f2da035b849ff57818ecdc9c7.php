...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form id="purchase" action="<?php echo e(url('admin/return_adjust_patient')); ?>" method="post">
           <?php echo csrf_field(); ?>
      <div class="row">
        <div class="col-lg-12">
...
<div id="show_add_to_cart_item">
  <table class="table table-bordered scrollContent">
          ...
          <tbody>
              ...
              <input type="hidden" name="bill_id" id="bill_id" value="<?php echo e($data->bill_id); ?>">
              <input type="hidden" name="pat_id" id="pat_id" value="<?php echo e($data->pat_id); ?>">
...
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xamppp\htdocs\hospital_management\modern_hospital_private\resources\views/admin/pharmacysell/phamedsellreturnbypatient.blade.php ENDPATH**/ ?>