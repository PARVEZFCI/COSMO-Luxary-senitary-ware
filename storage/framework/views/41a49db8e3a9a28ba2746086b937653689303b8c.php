        ...
        <div class="col-lg-8">
          ...
          <div class="card bg-dark">
      		<div class="card-header border-0 bg-transparent text-white">
                <i class="fa fa-list"></i><span>  Hospital Charge Manage </span>
            </div>

            <div class="card">
            <div class="card-header">
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-plus-circle"></i> Add New Hospital Charge  
              </div> 
            </div>
            
            <div class="card-body">

              <form action="<?php echo e(url('admin/hospitalchargeac')); ?>" id="qcat" method="post">
              <?php echo csrf_field(); ?>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control" id="charge_name" name="charge_name" placeholder="Enter Charge Name">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <a href="<?php echo e(url('admin/hospitalcharge')); ?>" class="btn btn-dark btn-block col-md-offset-2">
...
$("#cus_order_id").on('keyup',function(){
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/hospitalcharge/hospitalchargeadd.blade.php ENDPATH**/ ?>