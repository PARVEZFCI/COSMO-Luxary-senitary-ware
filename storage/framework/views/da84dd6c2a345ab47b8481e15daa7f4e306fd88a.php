...
<div class="clearfix"></div>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <?php endif; ?>
              ...
              <form action="<?php echo e(url('admin/medicinereturnbypatientbillview')); ?>" method="post">
              <?php echo csrf_field(); ?>
                ...
                <div class="col-md-6">         
                  <div class="form-group" style="margin-bottom: 0rem;">
                    ...
                    <select type="text" class="form-control" id="patient_id" name="patient_id" required="">
                        ...
                        <?php $__currentLoopData = $patient_info; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH G:\xamppp\htdocs\hospital_management\modern_hospital_private\resources\views/admin/pharmacysell/medicinereturnbypatient.blade.php ENDPATH**/ ?>