  ...
  <table width="900px" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="50%" height="30" class="sagor">Bill ID : <strong><?php echo e($bill_manage->bill_id); ?></strong></td>
          <td width="50%" class="sagor">Report Date : <strong><?php echo e(date('d/m/Y')); ?></strong></td>
        </tr>
        <tr>
    ...
    <tr>
       <td colspan="3">
        ...
        <?php $__currentLoopData = $alltest; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

        <tr style="text-align: center;">
          <td style="border-bottom: 1px solid #000;border-top: 1px solid #000;border-left: 1px solid #000;border-right: 1px solid #000;">
            <?php echo e($row->charge_name); ?>
...
<?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/lab/alltestlistprint.blade.php ENDPATH**/ ?>