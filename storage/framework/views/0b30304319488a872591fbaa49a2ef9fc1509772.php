...
<div class="clearfix"></div>
        ...
        <?php endif; ?>
          ...
          <div class="card bg-dark">
            ...
            <div class="card-header">
              ...
              <div style="display:inline-block; padding-top:5px;">
                <i class="fa fa-table"></i> Office Bill List | Date : <?php echo e($from_date_new); ?> to <?php echo e($to_date_new); ?> 
              </div> 
            ...
            <div class="card-body">
              ...
              <table id="dataTable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr style="background: #15ca20; color: #ffffff;">
                        <td colspan="3" style="text-align: right;"> Total : </td>
                        <td><?php echo e($gt); ?> TK </td>
                        <td><?php echo e($pay); ?> TK </td>
                        <td><?php echo e($due); ?> TK </td>
                        <td colspan="2"></td>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH N:\XAMPP-72\htdocs\SOFTWARE-NEW\MODERN-HOSPITAL-PRIVATE\resources\views/admin/office/officebilllistquery.blade.php ENDPATH**/ ?>