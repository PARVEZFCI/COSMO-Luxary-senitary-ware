...
<div class="clearfix"></div>
                  ...
                  <div class="col-md-6">
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" value="<?php echo e($customer->openig_due); ?>" type="text" class="form-control"  name="openig_due" placeholder="openig_due">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select name="status" class="form-control">
                            <option value=""><?php if($customer->customer_status == 1 ): ?>
                              Active
                              <?php else: ?> 
                              Deactive
                              <?php endif; ?>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('expert.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\SERVER\htdocs\AB-Ceramic-Industries\resources\views/admin/customer/customeredit.blade.php ENDPATH**/ ?>