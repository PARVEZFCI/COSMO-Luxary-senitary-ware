...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <form id="purchase" action="{{url('admin/cashmemomanage')}}" method="post">
           @csrf
      <div class="row">
        <div class="col-lg-12">
    ...
    <h4 class="text-center pt-3">Select Customer</h4><hr>
       ...
       <div class="card-body">
          ...
          <div class="row">
           <input type="hidden" name="cashmemo" id="cashmemo" value="{{$billid}}">
                   ...
                   <label>Customer Name</label>
                    <select class="form-control" id="customer_code" name="customer_code">
                        ...
                        <option value="">Select customer name & Code </option>
                            ...
                            <option value="{{$data->customer_code}}">
               ...
               <div  class="row">
                    ...
                    {{-- <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <input class="form-control"  value="{{$total_quantity}}" readonly=""  type="text" id="ctn_pcs_t" name="ctn_pcs_t" placeholder="" >
                      </div>
...
/*alert(cashmemoid);*/
   $.ajax({
        url: "{{url('admin/calculate_total_ctn_with_comm')}}",
        data: {cashmemoid:cashmemoid},
        success: function(data){
        $("#t_w_comm").html(data);
        $("#t_w_comm").val(data);
...
swal({
      ...
      .then((willDelete) => {
          if (willDelete) {
              $.ajax({
                  url: "{{url('admin/med_sales_delete_from_cart_add_page')}}",
                  data: {data},
                  success: function(data){
                    $("#purchase").find("#show_add_to_cart_item").html(data);
