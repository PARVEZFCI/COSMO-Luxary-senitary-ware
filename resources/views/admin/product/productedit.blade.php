        ...
        <div class="col-lg-8">
          ...
          <div class="card bg-dark">
            ...
            <div class="card-body">
              ...
              <form action="{{url('admin/productUpdate',$productdetails->id)}}" id="qcat" method="post">
              @csrf
              ...
              <div class="row">
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" id="product_type" name="product_type">
                            ...
                            <option >{{$productdetails->product_type}}</option>
                          @foreach($type as $row) 
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" class="form-control"  name="product_code" placeholder="Enter product  code" value="{{$productdetails->product_code}}">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" type="text" value="{{$productdetails->product_name}}" class="form-control"  name="product_name" placeholder="Enter product  name">
                      </div>
                  </div>
                      ...
                      <div class="form-group">
                          <label for="name">Product Specification </label>
                            ...
                            <select name="product_specification" id="product_specification" class="form-control">
                              <option>{{$productdetails->product_specification}}</option>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" value="{{$productdetails->unit_mesurement}}" type="text" class="form-control"  name="unit_mesurement" placeholder="Entr unit mesurement">
                      </div>
                  </div>
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="grade">
                          	<option value="{{$productdetails->grade}}">Select Grade</option>
                          	<option>A</option>
                          	<option>B</option>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" value="{{$productdetails->unit_price}}" name="unit_price" class="form-control">
                      </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" value="{{$productdetails->comission}}" name="comission" class="form-control" placeholder=" ENTR Comission ">
                      </div>
                  </div>
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="text" value="{{$productdetails->bonus}}" name="bonus" name="bonus" class="form-control" placeholder="Enter Bonus">
                      </div>
                  </div>
                   ...
                   <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select name="bonus_option" class="form-control">
                            <option value="{{$productdetails->bonus_option}}"></option>
                            <option>Yes</option>
                            <option>No</option>
                          </select>
                      </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="date" value="{{$productdetails->date}}" name="date" class="form-control" placeholder=" ENTR bonus  ">
                      </div>
                  </div>
