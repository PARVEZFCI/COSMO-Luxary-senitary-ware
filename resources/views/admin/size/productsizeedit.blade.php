        ...
        <div class="col-lg-8">
          ...
          <div class="card bg-dark">
            ...
            <div class="card-body">
              ...
              <form action="{{url('admin/sizeUpdate',$productsize->id)}}" id="qcat" method="post">
              @csrf
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <select class="form-control" name="product_type">
                          	<option >{{$productsize->product_type}}</option>
                          	@foreach($type as $row)
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input required="" value="{{$productsize->size}}" type="text" class="form-control" id="amount" name="size" placeholder="Enter product Size">
                      </div>
                  </div>
