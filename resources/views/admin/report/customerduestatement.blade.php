...
$setting = DB::table('settings')
  ...
  @endphp
  @foreach($customerstatement as $row)

  @php
   
   $real +=$row->openig_due;

   $f_t +=$row->f_openig_due;
...
@endphp
  ...
  <tr>
    ...
    <td style="border-right: 1px solid rgb(0,0,0); ">&nbsp;&nbsp;<b>Total</b></td>
    <td style="border-right: 1px solid rgb(0,0,0);text-align: right; ">
      <b>
...
<table width="1000"  align="center">
  <tr>
    <td style="text-align: center;" class="noprint"> <a  href="{{URL::to('admin/dashboard')}}" style="background: #db5246; border: 1px solid #db5246; padding:20px; color: #ffffff; text-decoration: none; ">back</a></td>
