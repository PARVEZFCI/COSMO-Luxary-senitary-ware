   ...
   <tr>
      ...
      <div align="center">
       ...
       $w_c_t = 0;
        ...
        @endphp
       @foreach($dailysalestatment as $row)
</div>
...
<table width="1200"  align="center">
  <tr class="noprint">
    <td style="text-align: center;"> <a href="{{URL::to('admin/selectdatedailysales')}}" style="background: #db5246; border: 1px solid #db5246; padding:20px; color: #ffffff; text-decoration: none; ">back</a></td>
