...
<html>
	<head>
		...
		<link rel="stylesheet" href="{{ asset('/expert/wizard/fonts/material-design-iconic-font/css/material-design-iconic-font.css') }}">
		<!-- DATE-PICKER -->
		<link rel="stylesheet" href="{{ asset('/expert/wizard/vendor/date-picker/css/datepicker.min.css') }}">
		<!-- STYLE CSS -->
		<link rel="stylesheet" href="{{ asset('/expert/wizard/css/style.css') }}">
		<!-- notifications css -->
	...
	<body>
		...
		<script src="{{ asset('/expert/wizard/js/jquery-3.3.1.min.js') }}"></script>
		
		<!-- JQUERY STEP -->
		<script src="{{ asset('/expert/wizard/js/jquery.steps.js') }}"></script>

		<!-- DATE-PICKER -->
		<script src="{{ asset('/expert/wizard/vendor/date-picker/js/datepicker.js') }}"></script>
		<script src="{{ asset('/expert/wizard/vendor/date-picker/js/datepicker.en.js') }}"></script>
      					...
      					$.ajax({
							...
							success: function(data){
								...
								if(data.status=='success') {
									...
									setTimeout(function(){ location.replace('{{route("home")}}'); }, 500);
								} else {
									Lobibox.notify('error', {
										pauseDelayOnHover: true,
										continueDelayOnInactiveTab: false,
